...
func SettingsDatabaseCennection() string {
	return fmt.Sprintf("%s:%s@tcp(%s:%s)/%s?parseTime=true", os.Getenv("USER_DB"), os.Getenv("PASSWD_DB"), os.Getenv("HOST_DB"), os.Getenv("PORT_DB"), os.Getenv("NAME_DB"))
}
...
func CreateServer() *gin.Engine {
	...
	// 	log.Fatal(err)
	// }
	// repo := productRepository.NewMariaDBRepository(conn)
